      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="login_adm.php">Administrar</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong><img src="img/logo1.png" alt="Conexion" title="Sitema Conexion"/></strong>
            </h1>
            <hr>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Hola, <?php echo $_SESSION["user"]; ?> </h2>
            <hr class="light my-4">
            <p class="text-faded mb-4"></p>
            <a class="btn btn-light btn-xl js-scroll-trigger" href="#participantes">Empezemos!</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-5 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class=" text-primary mb-3 sr-icons"><img src="img/<?php echo $mostrar['foto']; ?>" alt="<?php echo $mostrar['empleado_id']; ?>"/></i>
              <h3 class="mb-3"><?php echo $mostrar['nombre'] ." " .$mostrar['apellido']; ?></h3> 
             <p class="text-muted mb-0"><?php echo $mostrar['sede']; ?></p>
             	<form action="resultado.php" method="POST">
                	<label for="enviar"></label>
                    	 <input name="IDemple" type="hidden" value="<?php echo $mostrar['empleado_id']; ?>">
                    	 <input type="submit" name="enviar" class="btn" id="enviar" value="<?php echo $mostrar['nombre'] ?>"/> </form><h2><a href="#" class="fa fa-thumbs-o-up"></a></h2>
            </div>
          </div>
<?php }
